                ...
                <div class="col-12">
                  <div class="card">
                    ...
                    <div class="form-group">
                            <div class="col-md-6">
                                <img width="200" height="200" @if($data->dokter->cover) src="{{ asset('images/dokter/'.$data->dokter->cover) }}" @endif />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="anggota_id" class="col-md-4 control-label">dokter</label>
                            <div class="col-md-6">
                                <input id="dokter" type="text" class="form-control" readonly="" value="{{$data->dokter->judul}}">
