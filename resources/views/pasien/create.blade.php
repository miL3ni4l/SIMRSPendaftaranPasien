                    ...
                    <div class="card-body">
                      <h4 class="card-title">Tambah Pasien Baru</h4>
                        ...
                        <div class="form-group{{ $errors->has('nip') ? ' has-error' : '' }}">
                            <label for="nip" class="col-md-4 control-label">No Pasien</label>
                            <div class="col-md-6">
                                <input id="nip" type="number" class="form-control" name="nip" value="{{ old('nip') }}" maxlength="8" required>
                                @if ($errors->has('nip'))
                                    <span class="help-block">
                        ...
                        <a href="{{route('pasien.index')}}" class="btn btn-light pull-right">Back</a>
                    </div>
                  </div>
                </div>
              </div>
